    ...
    <div>
        ...
        <div className="frtend-header">
          ...
          <div className="icon-links">
            <NavLink to="/shoping" className="user-actions">
              ...
              {product.length > 0 && <span className='counter'>{product.length}</span>}
              <div>Корзина</div>
            </NavLink>
      ...
      <div className="navbar-mobile">
        <div onClick={() => handleItemClick(false, "house")}>
          <NavLink to="/"><FontAwesomeIcon icon={faHouse} className={`fa-light fa-house icon-mobile-menu ${ location.pathname !== "/shoping" ? "icon-mobile-menu-active" : ""}`} /></NavLink>
        </div>
        <div onClick={() => handleItemClick(!openburger, "bars")}>
          <FontAwesomeIcon icon={faBars} className={`fa-solid fa-bars icon-mobile-menu`} />
        </div>
        <div onClick={() => handleItemClick(false, "shopping")}>
          {product.length > 0 && <span className='counter'>{product.length}</span>}
          <NavLink to="/shoping"><FontAwesomeIcon icon={faCartShopping} className={`fa-thin fa-cart-shopping icon-mobile-menu ${ location.pathname === "/shoping" ? "icon-mobile-menu-active" : ""}`} /></NavLink>
        </div>
